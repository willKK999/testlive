...
class OLNobleTopView: UIView {
    ...
    var itemWidth = oScreenWidth/7.0
    ...
    let selectedX = oScreenWidth/7/2 - 7
    lazy var selectedBottomLine: UIView = {
        let view = UIView(frame: CGRect(x:selectedX, y: 36, width: 14, height: 2))
...
extension OLNobleTopView: UICollectionViewDelegate,UICollectionViewDataSource,UIScrollViewDelegate {
