...
class OLStudioGamesTopView: UIView {
    ...
    let selectedX = oScreenWidth/12 - 8
    lazy var selectedBottomLine: UIView = {
        let view = UIView(frame: CGRect(x:selectedX + itemWidth, y: 35, width: 16, height: 2))
...
extension OLStudioGamesTopView: UICollectionViewDelegate,UICollectionViewDataSource,UIScrollViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell?.titleLabel.text = gameCodes[indexPath.row].name
