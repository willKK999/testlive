...
#ifndef kIsNetwork
#define kIsNetwork     [QNNetworkHelper isNetwork]  // 一次性判断是否有网的宏
#endif

#ifndef kIsWWANNetwork
#define kIsWWANNetwork [QNNetworkHelper isWWANNetwork]  // 一次性判断是否为手机网络的宏
#endif

#ifndef kIsWiFiNetwork
#define kIsWiFiNetwork [QNNetworkHelper isWiFiNetwork]  // 一次性判断是否为WiFi网络的宏
#endif

typedef NS_ENUM(NSUInteger, QNNetworkStatusType) {
    /// 未知网络
    QNNetworkStatusUnknown,
    /// 无网络
    QNNetworkStatusNotReachable,
    /// 手机网络
    QNNetworkStatusReachableViaWWAN,
    /// WIFI网络
    QNNetworkStatusReachableViaWiFi
};
...
/// 网络状态的Block
typedef void(^QNNetworkStatus)(QNNetworkStatusType status);

@class AFHTTPSessionManager;
@interface QNNetworkHelper : NSObject
 ...
 * 内修改,再加上此封装在支持CocoaPods后,如果使用者pod update最新QNNetworkHelper,那又要重新修改此
 * 封装内的相关参数.
 *
 ...
 * 了,大大降低了项目的后期维护难度
 *
 * 综上所述,最终还是将设置参数的接口暴露出来,如果通过CocoaPods方式使用QNNetworkHelper,在设置项目网络
