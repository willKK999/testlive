...
class OLNavigationController: UINavigationController, UIGestureRecognizerDelegate {
    ...
    override func pushViewController(_ viewController: UIViewController, animated: Bool) {
        if self.children.count > 0 {
            ...
            button.setImage(OLImage.arrow_left_back, for: .normal)
    ...
    public func configNormalNavBarAppearance() {
        ...
        if #available(iOS 13.0, *) {
            ...
            //设置导航栏背景色
            appearance.backgroundColor =  OLColors.hex_FFFFFF
            navigationBar.isTranslucent = false

            //设置导航栏标题字体颜色
            appearance.titleTextAttributes = [.foregroundColor: OLColors.hex_333333,
                                              .font: OLFont.PingFang_Medium18]
           
            //设置导航栏按钮颜色
            let buttonAppearance = UIBarButtonItemAppearance()
            buttonAppearance.normal.titleTextAttributes = [.foregroundColor: OLColors.hex_666666,
                                                           .font: OLFont.PingFang_Medium12,
                                                           .shadow: shadow]
            appearance.buttonAppearance = buttonAppearance
            
            appearance.shadowColor = OLColors.hex_FFFFFF
            //静止样式
            ...
            //设置导航栏背景色
            navigationBar.barTintColor = OLColors.hex_FFFFFF
            navigationBar.isTranslucent = false
            navigationBar.setBackgroundImage(nil, for: .default)
            
            //设置导航栏标题字体颜色
            navigationBar.titleTextAttributes = [.foregroundColor: OLColors.hex_333333,
                                                 .font: OLFont.PingFang_Medium18]

            //设置导航栏按钮颜色
            navigationBar.tintColor = OLColors.hex_666666
    ...
    /// 配置全透明模式导航栏样式
    public func configClearNavBarAppearance() {
        if #available(iOS 13.0, *) {
            let appearance = UINavigationBarAppearance()
            //重置背景和阴影属性为透明
            ...
            navigationBar.isTranslucent = true
            navigationBar.setBackgroundImage(UIImage(ciImage: .clear), for: .default)
