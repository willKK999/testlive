...
//    static var DOMAIN_DEBUG = "http://b540-45-112-46-93.ngrok.io/"
    ...
    public struct UserCenter {
        ///POST /userCenter/app/v1/getUserInfo获取用户基本信息
        public static let getUserInfo = OLAPIItem("/userCenter/app/v1/getUserInfo", d: "获取用户基本信息", m: .post)
        ///POST /userCenter/app/v1/getUserLevelInfo查询用户当前等级信息
        public static let getUserLevelInfo = OLAPIItem("/userCenter/app/v1/getUserLevelInfo", d: "用户当前等级信息", m: .post)
        ///POST /userCenter/app/v1/getUserOccupationList获取用户职业列表信息
        public static let getUserOccupationList = OLAPIItem("/userCenter/app/v1/getUserOccupationList", d: "用户职业列表信息", m: .post)
    }
    ...
    public struct Lottery {
        ...
        ///POST /lottery/app/v1/queryLotteryVersionZIP获取彩种赔率玩法
        public static let queryLotteryVersionZIP = OLAPIItem("/lottery/app/v1/queryLotteryVersionZIP", d: "获取彩种赔率玩法", m: .post)
    }
    
    // MARK: 彩票 投注
    public struct Bet {
        ///POST /bet/orderBet老彩种购彩投注
        public static let orderBet = OLAPIItem("/bet/orderBet", d: "老彩种购彩投注", m: .post)
        ///POST /bet/orderBetNew新彩种购彩投注
        public static let orderBetNew = OLAPIItem("/bet/orderBetNew", d: "新彩种购彩投注", m: .post)
        ///POST /bet/orderList用户投注列表记录
        public static let orderList = OLAPIItem("/bet/orderList", d: "用户投注列表记录", m: .post)
    }
    
    // MARK: 彩票 开奖
    public struct Sg {
        ///POST /sg/getNewestSgInfoByIds.json获取下一期彩种信息
        public static let getNewestSgInfoByIds = OLAPIItem("/sg/getNewestSgInfoByIds.json", d: "获取下一期彩种信息", m: .post)
        ///POST /sg/getSgLongDragons.json查询长龙
        public static let getSgLongDragons = OLAPIItem("/sg/getSgLongDragons.json", d: "查询长龙", m: .post)
        ///POST /sg/lishiSg.json根据ID查询彩种的开奖历史信息
        public static let lishiSg = OLAPIItem("/sg/lishiSg.json", d: "根据ID查询彩种的开奖历史信息", m: .post)
    }
    
    // MARK: 游戏
    public struct Game {
        ///POST /game/app/v1/queryBalance查询游戏余额
        public static let lishiSg = OLAPIItem("/game/app/v1/queryBalance", d: "游戏余额", m: .post)
        ///POST /game/app/v1/queryGameTagList查询游戏分类列表
        public static let queryGameTagList = OLAPIItem("/game/app/v1/queryGameTagList", d: "游戏分类列表", m: .post)
        ///POST /game/app/v1/queryGameListByTag根据标签ID查询游戏列表
        public static let queryGameListByTag = OLAPIItem("/game/app/v1/queryGameListByTag", d: "ID查询游戏列表", m: .post)
    }
